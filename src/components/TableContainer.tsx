  ...
  return (
    <main className="w-full px-2 lg:px-40 py-4">
      <div className="w-full overflow-x-hidden">
        <div className="mb-4 flex flex-col lg:flex-row justify-between gap-y-5">
          <button
            className="w-full lg:w-auto bg-brand-primary text-white px-4 py-2 rounded hover:bg-brand-darker hover:cursor-pointer"
            onClick={() =>
              ...
              {letOutReservations.map((r, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      {renderAppointed(r, "letOut")}
                    </td>
                    <td className="py-3 px-4">
                      {renderConfirmed(r, "letOut")}
                    </td>
                    <td className="py-3 px-4">
              ...
              {returnReservations.map((r, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      {renderAppointed(r, "return")}
                    </td>
                    <td className="py-3 px-4">
                      {renderConfirmed(r, "return")}
                    </td>
                    <td className="py-3 px-4">
